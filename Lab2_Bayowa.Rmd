...
## My research question is "Does age determine the income of black population across U.S. states/regions?"
...
## Box plot showing Right/Positive skew for Young adults.
```{r}
ggplot(combined_data_clean, aes(x = median_income, y = age_group)) +
  geom_boxplot() +
  labs(title = "Distribution of Median Income for Black Adults by Age Group",
...
##This is in contrast to my test done with a triad grouping and more grouping of my data which shows the relationship between black median income and age is statistically significant with a p-value of 0.0206. This could mean that age group has an impact on median age for black adults across the U.S
